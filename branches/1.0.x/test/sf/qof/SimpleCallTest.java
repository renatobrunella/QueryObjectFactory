...
public class SimpleCallTest extends TestCase {
  ...
  public void testCallByte() throws SQLException {
	...
	assertEquals(55, ((Byte) callQueries.callByte2((byte) 33, null))
		.byteValue());
	int i = 0;
	...
	assertEquals("registerOutParameter(1," + java.sql.Types.TINYINT + ")", log
		.get(i++));
  ...
  public void testCallChar() throws SQLException {
	...
	assertEquals('A', ((Character) callQueries.callChar2('c', null))
		.charValue());
	int i = 0;
	...
	assertEquals("registerOutParameter(1," + java.sql.Types.VARCHAR + ")", log
		.get(i++));
	assertEquals("execute()", log.get(i++));
  ...
  public void testCallShort() throws SQLException {
	...
	assertEquals(55, ((Short) callQueries.callShort2((short) 33, null))
		.shortValue());
	int i = 0;
	assertEquals(15, log.size());
	assertEquals("prepareCall({  ? = call func ( ? , ? )  })", log.get(i++));
	...
	assertEquals("registerOutParameter(1," + java.sql.Types.SMALLINT + ")", log
		.get(i++));
	assertEquals("execute()", log.get(i++));
  ...
  public void testCallInteger() throws SQLException {
	...
	((MockConnectionData)connection).setResultData(result);
	assertEquals(55, callQueries.callInteger1((short) 11, new Integer(
		(short) 22)));
	assertEquals(55, ((Integer) callQueries.callInteger2((short) 33, null))
		.shortValue());
	int i = 0;
	assertEquals(15, log.size());
	assertEquals("prepareCall({  ? = call func ( ? , ? )  })", log.get(i++));
	...
	assertEquals("registerOutParameter(1," + java.sql.Types.INTEGER + ")", log
		.get(i++));
	assertEquals("execute()", log.get(i++));
  ...
  public void testCallLong() throws SQLException {
	...
	assertEquals(55, ((Long) callQueries.callLong2((long) 33, null))
		.longValue());
	int i = 0;
	assertEquals(15, log.size());
	assertEquals("prepareCall({  ? = call func ( ? , ? )  })", log.get(i++));
	...
	assertEquals("registerOutParameter(1," + java.sql.Types.BIGINT + ")", log
		.get(i++));
	assertEquals("execute()", log.get(i++));
  ...
  public void testCallFloat() throws SQLException {
	...
	((MockConnectionData)connection).setResultData(result);
	assertEquals((float) 55.5, callQueries.callFloat1((float) 11.1, new Float(
		(float) 22.2)));
	assertEquals((float) 55.5, ((Float) callQueries.callFloat2((float) 33.3,
		null)).floatValue());
	int i = 0;
	assertEquals(15, log.size());
	assertEquals("prepareCall({  ? = call func ( ? , ? )  })", log.get(i++));
	...
	assertEquals("registerOutParameter(1," + java.sql.Types.REAL + ")", log
		.get(i++));
	assertEquals("execute()", log.get(i++));
  ...
  public void testCallDouble() throws SQLException {
	...
	((MockConnectionData)connection).setResultData(result);
	assertEquals(55.5, callQueries.callDouble1((double) 11.1, new Double(
		(double) 22.2)));
	assertEquals(55.5, ((Double) callQueries.callDouble2((double) 33.3, null))
		.doubleValue());
	int i = 0;
	assertEquals(15, log.size());
	assertEquals("prepareCall({  ? = call func ( ? , ? )  })", log.get(i++));
	...
	assertEquals("registerOutParameter(1," + java.sql.Types.DOUBLE + ")", log
		.get(i++));
	assertEquals("execute()", log.get(i++));
  ...
  public void testCallDate() throws SQLException {
	...
	((MockConnectionData)connection).setResultData(result);
	assertEquals(new java.util.Date(0).getTime(), callQueries.callDate(
		new java.util.Date(0)).getTime());
	assertEquals(new java.util.Date(0).getTime(), callQueries.callDate(null)
		.getTime());
	int i = 0;
	assertEquals(12, log.size());
	assertEquals("prepareCall({  ? = call func ( ? )  })", log.get(i++));
	assertEquals("setDate(2,1970-01-01)", log.get(i++));
	assertEquals("registerOutParameter(1," + java.sql.Types.DATE + ")", log
		.get(i++));
	assertEquals("execute()", log.get(i++));
  ...
  public void testCallTime() throws SQLException {
	...
	((MockConnectionData)connection).setResultData(result);
	assertEquals(new java.util.Date(0).getTime(), callQueries.callTime(
		new java.util.Date(0)).getTime());
	assertEquals(new java.util.Date(0).getTime(), callQueries.callTime(null)
		.getTime());
	int i = 0;
	assertEquals(12, log.size());
	assertEquals("prepareCall({  ? = call func ( ? )  })", log.get(i++));
	assertEquals("setTime(2,01:00:00)", log.get(i++));
	assertEquals("registerOutParameter(1," + java.sql.Types.TIME + ")", log
		.get(i++));
	assertEquals("execute()", log.get(i++));
  ...
  public void testCallTimestamp() throws SQLException {
	...
	((MockConnectionData)connection).setResultData(result);
	assertEquals(new java.util.Date(0).getTime(), callQueries.callTimestamp(
		new java.util.Date(0)).getTime());
	assertEquals(new java.util.Date(0).getTime(), callQueries.callTimestamp(
		null).getTime());
	int i = 0;
	...
	assertEquals("registerOutParameter(1," + java.sql.Types.TIMESTAMP + ")",
		log.get(i++));
	assertEquals("execute()", log.get(i++));
